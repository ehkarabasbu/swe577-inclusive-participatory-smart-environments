...
% ===============================
% STATEMENT OF AI USAGE (OUR ADVISOR'S EXPECTATION)
% ===============================
\section{Statement of AI Usage}
In the preparation of this term paper, Artificial Intelligence (AI) tools were utilized to assist with the following specific purposes:
\begin{itemize}
    \item creating initial github repository structure
    \item github repository issue task list generation from raw paragraphs
    \item additional search on some found papers' references
    \item public codebase search for found papers
    \item understanding some libraries and frameworks in found codebases
    \item converting raw texts authored by myself (the author) to md files for wiki pages
    \item rephrasing some sentences in proper academic tone
    \item fixing tex file formatting issues
\end{itemize}
All research, conceptualization, core analysis, and final synthesis of the findings represent the original work of the authors.
